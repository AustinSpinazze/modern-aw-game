    ...
    weapons: [
      {
        ...
        min_range: 1, max_range: 1, can_counterattack: true, ammo: 3,
...
export const MOCK_TERRAIN: Record<string, TerrainData> = {
  plains: {
    id: "plains", name: "Plains", defense_stars: 0, is_property: false,
    can_capture: false, income: 0, can_produce: [],
    can_build_trench: true, can_build_fob: true,
    movement_costs: { foot: 1, mech: 1, tires: 2, tread: 1, air: 1, ship: -1, trans: -1 },
  },
  city: {
    id: "city", name: "City", defense_stars: 3, is_property: true,
    can_capture: true, income: 1000, can_produce: [],
    can_build_trench: false, can_build_fob: false,
    movement_costs: { foot: 1, mech: 1, tires: 1, tread: 1, air: 1, ship: -1, trans: -1 },
  },
  factory: {
    id: "factory", name: "Factory", defense_stars: 3, is_property: true,
    can_capture: true, income: 1000, can_produce: ["infantry", "tank", "apc", "artillery"],
    can_build_trench: false, can_build_fob: false,
    movement_costs: { foot: 1, mech: 1, tires: 1, tread: 1, air: 1, ship: -1, trans: -1 },
  },
  hq: {
    id: "hq", name: "HQ", defense_stars: 4, is_property: true,
    can_capture: true, income: 1000, can_produce: [],
    can_build_trench: false, can_build_fob: false,
    movement_costs: { foot: 1, mech: 1, tires: 1, tread: 1, air: 1, ship: -1, trans: -1 },
  },
  mountain: {
    id: "mountain", name: "Mountain", defense_stars: 4, is_property: false,
    can_capture: false, income: 0, can_produce: [],
    can_build_trench: false, can_build_fob: false,
    movement_costs: { foot: 2, mech: 1, tires: -1, tread: -1, air: 1, ship: -1, trans: -1 },
  },
  sea: {
    id: "sea", name: "Sea", defense_stars: 0, is_property: false,
    can_capture: false, income: 0, can_produce: [],
    can_build_trench: false, can_build_fob: false,
    movement_costs: { foot: -1, mech: -1, tires: -1, tread: -1, air: 1, ship: 1, trans: 1 },
  },
  temporary_fob: {
    id: "temporary_fob", name: "FOB", defense_stars: 3, is_property: false,
    can_capture: false, income: 0, can_produce: [],
    can_build_trench: false, can_build_fob: false,
    movement_costs: { foot: 1, mech: 1, tires: 1, tread: 1, air: 1, ship: -1, trans: -1 },
  },
