/**
 * Map generator: prompts an LLM to emit AWBW CSV tile grids, parses via {@link ../game/awbwImport},
 * used from the map editor chat UI. Model selection follows {@link ../store/configStore}.
 */
...
import { parseAwbwMapText } from "../game/awbwImport";
