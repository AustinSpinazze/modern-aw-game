/**
 * **Unit sprites** (idle + facing) with team tints; works with {@link ./movementAnimator} during moves.
 */
...
import { UNIT_ANIMATIONS, UNIT_ANIMATION_SPEED, getArmySheet } from "./spriteMapping";
