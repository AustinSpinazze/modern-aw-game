/**
 * **Movement playback**: steps units along a path with directional {@link spriteMapping} animations.
 */

import { AnimatedSprite, Container } from "pixi.js";
import type { Vec2 } from "../game/types";
import { TILE_SIZE, TILE_SCALE, getAnimation } from "./pixiApp";
import { UNIT_ANIMATIONS, UNIT_MOVE_DIRECTIONS, getArmySheet } from "./spriteMapping";
